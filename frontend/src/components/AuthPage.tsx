    ...
    <div className="auth-page">
      ...
      <div className="auth-container">
        <div className="auth-header">
          ...
          <p className="auth-tagline">Тэмцээний Төв</p>
        </div>

        <h2 className="auth-title">НЭВТРЭХ</h2>

        <p className="auth-subtitle">Discord бүртгэлээрээ нэвтэрч үргэлжлүүлнэ үү</p>

        <button className="discord-login-btn" onClick={loginWithDiscord}>
