...
import type { ModeratorStats } from "../components/moderator/types";

// Lazy Load Tabs
const OverviewTab = lazy(() => import("../components/moderator/OverviewTab"));
const MatchesTab = lazy(() => import("../components/moderator/MatchesTab"));
const PlayersTab = lazy(() => import("../components/moderator/PlayersTab"));
const ClansTab = lazy(() => import("../components/moderator/ClansTab"));
const AuditLogTab = lazy(() => import("../components/moderator/AuditLogTab"));
const TournamentsTab = lazy(() => import("../components/moderator/TournamentsTab"));
