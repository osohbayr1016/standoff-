        ...
        <div className="space-y-8 animate-fade-in-up">
          <div className="space-y-4">
            ...
            <p className="text-xl text-zinc-400 max-w-lg leading-relaxed font-light">
              Welcome to Mongolia's largest Standoff 2 tournament platform. Join the community and prove your skills.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-4 rounded-xl space-y-2 hover:bg-white/10 transition-colors cursor-default group">
              ...
              <p className="text-xs text-zinc-500 leading-tight">Join 10,000+ players and make new friends.</p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-4 rounded-xl space-y-2 hover:bg-white/10 transition-colors cursor-default group">
              ...
              <p className="text-xs text-zinc-500 leading-tight">Get the latest tournament news and updates on Discord.</p>
            </div>
          </div>
          ...
          >
            JOIN OUR DISCORD SERVER <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
          </a>
        </div>
            ...
            <CardContent className="p-0 space-y-8 relative z-10 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-zinc-500 text-sm">
                  Use the button below to log in. <br />
                  Your account will be created automatically via Discord.
                </p>
              </div>
